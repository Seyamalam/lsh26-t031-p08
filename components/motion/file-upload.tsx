  ...
  return (
    ...
    >
      <div className="flex items-center gap-3">
        ...
        >
          {createElement(getFileIcon(item), { className: "h-5 w-5" })}
        </div>
        ...
        <div className={cn("min-w-0 flex-1", classNames?.content)}>
          ...
          {showProgress ? (
            <div
              ...
              aria-label={`${item.name} file processing progress`}
              className={cn(
    ...
    <div className={cn("w-full space-y-3", className, classNames?.root)}>
      ...
      >
        ...
        <span className={cn("min-w-0", centered ? "max-w-xs" : "flex-1")}>
          ...
          >
            {maxReached ? "File selected" : title}
          </span>
          <span
            className={cn(
          ...
          >
            {maxReached
              ? `${items.length} of ${maxFiles} files selected`
              : description}
          </span>
        </span>
